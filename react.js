...
ReactDOMComponent.Mixin = {
  ...
  _processCustomAttributes: function(props) {
    if (props.dataset && typeof props.dataset === 'object') {
      var objectProps = Object.keys(props.dataset),
        objectPropName,
        objectPropValue;

      for (var i = 0, l = objectProps.length; i < l; i++) {
        objectPropName = objectProps[i];
        objectPropValue = props.dataset[objectPropName];
  ...
  _createOpenTagMarkup: function() {
    ...
    this._processCustomAttributes(props);
  ...
  _updateDOMProperties: function(lastProps) {
    ...
    var styleName;
    var styleUpdates;
    this._processCustomAttributes(nextProps);
